...
class ASST(nn.Module):
    ...
    first across the temporal dimension and then across the spatial dimension.
    """
    ...
    def forward(self, x):
        ...
        if self.dow_embedding_dim > 0:
            ...
            # Clamp indices to be within the valid range [0, 6]
        ...
        # Sequentially apply attention: first temporal, then spatial
